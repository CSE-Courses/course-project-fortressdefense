...
public class drawPhaseOtherPlayer {
	...
	private void initialize() {
		...
		if (client != null) {
			lblName = new JLabel(client.getClass().getName() + "'s Turn");
		...
		int curBound = 10;
		for(int i = 1; i < gameServer.getModel().getPlayers().get(0).getHand().Size(); i++)
		{
			if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Axe)
			{
				curBtn.setIcon(new ImageIcon(axeImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Battle_Axe)
			{
				curBtn.setIcon(new ImageIcon(battleAxeImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Crossbow)
			{
				curBtn.setIcon(new ImageIcon(crossbowImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Mace)
			{
				curBtn.setIcon(new ImageIcon(maceImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Stick)
			{
				curBtn.setIcon(new ImageIcon(stickImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == AttackCard.Sword)
			{
				curBtn.setIcon(new ImageIcon(swordImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Barbed_Wire)
			{
				curBtn.setIcon(new ImageIcon(barbedWireImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Earthquake)
			{
				curBtn.setIcon(new ImageIcon(earthquakeImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Flood)
			{
				curBtn.setIcon(new ImageIcon(floodImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Iron_Door)
			{
				curBtn.setIcon(new ImageIcon(ironDoorImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Reinforced_Gate)
			{
				curBtn.setIcon(new ImageIcon(reinforcedGateImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Steel_Chains)
			{
				curBtn.setIcon(new ImageIcon(steelChainsImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Stone_Wall)
			{
				curBtn.setIcon(new ImageIcon(stoneWallImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Thunderstorm)
			{
				curBtn.setIcon(new ImageIcon(thunderstormImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Tornado)
			{
				curBtn.setIcon(new ImageIcon(tornadoImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == DefenseCard.Wooden_Wall)
			{
				curBtn.setIcon(new ImageIcon(woodenWallImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == SpecialCard.Archer_Tower)
			{
				curBtn.setIcon(new ImageIcon(archerTowerImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == SpecialCard.Scout)
			{
				curBtn.setIcon(new ImageIcon(scoutImg));
			}
			else if(gameServer.getModel().getPlayers().get(0).getHand().Select(i).getCard_name() == SpecialCard.Trade)
			{
